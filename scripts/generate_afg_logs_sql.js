...
const CSV_PATH = path.join(__dirname, '../src/BD/REGISTRO HORAS AFG - Hoja 1.csv');
const AFG_CLIENT_ID = 'b0132705-bbfa-469f-a589-36c43c9c45a8';
...
async function generate() {
    ...
    for (let i = 1; i < lines.length; i++) {
        const [fecha, nombre, tarea, horas] = parseCSVLine(lines[i]);
        ...
        const taskQuery = `(SELECT id FROM tasks WHERE title = '${cleanTarea}' AND client_id = '${AFG_CLIENT_ID}' LIMIT 1)`;
